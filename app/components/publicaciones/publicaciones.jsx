...
let likeImg = '/assets/likeIMG.svg';
let likeLogo = '/assets/like.svg';
let comment = '/assets/comment.svg';
let share = '/assets/share.svg';
...
function Publicaciones({empresa, seguidores, tiempo, contenido, imagen, logo, likes}) {
    ...
    return (
        <div className="flex flex-col w-full mt-1 mb-2 bg-white md:w-[50%] sm:w-[75%]">
